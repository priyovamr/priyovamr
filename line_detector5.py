...
while True :
    ...
    images = glob.glob('C:/Users/User/OneDrive - mail.ugm.ac.id/Dokumen/Github_ku/priyovamr/camera_cal/calibration*.jpg')
    ...
    image_cal = cv2.imread('C:/Users/User/OneDrive - mail.ugm.ac.id/Dokumen/Github_ku/priyovamr/camera_cal/calibration1.jpg')
    img_size = (image_cal.shape[1],image_cal.shape[0])
    ...
    grady = abs_sobel_thresh(gradx, orient='y', thresh_min=25, thresh_max=255)
    c_binary = color_threshold(grady, sthresh=(100,255), vthresh=(50,255))
    # preprocessImage[((gradx == 1) & (grady ==1) | (c_binary == 1))] = 255

    cv2.imshow("proses",c_binary)

    # hT, wT = preprocessImage.shape
    # points = valTrackbars()
    # imgWarp = warpImg(preprocessImage,points,wT,hT)
    # imgWarpPoints = drawPoints(imgCopy,points)
    # gray_image = cv2.cvtColor(imgWarp, cv2.COLOR_RGB2GRAY)
    # canny_image = cv2.Canny(gray_image, 100, 150, L2gradient=True)
